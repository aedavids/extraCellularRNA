'''
plots.barChartCommandLine -- shortdesc

plots.barChartCommandLine is a description
...
###############################################################################
class BarChartCommandLine( VolcanoPlotCommandLine ):
    '''
    ...
    def _build( self ):
        ...
        # https://stackoverflow.com/a/60796254/4586180
        self.requiredArg.add_argument('-i', '--inputFile', required=True, action='store', metavar="", 
                                 help="A csv file with 2 columns. the first column is x-axis label,"
                                        + " the second is the height. The header column names will be the"
                                        + " x and y axis labels")
        # metavar
