...
mainPython="../python/bigDataDeseq/parseSalmonReadsSplitCLI.py"
...
#
# find the urls to the files produced by parseSalmonReadsSelectCountsCLI
#
listOfFiles="/tmp/listOfFilesSelect.txt"
gsutil ls  gs://anvil-gtex-v8-hg38-edu-ucsc-kim-lab-spark/quant/test6Samples/parseSalmonReadsSelectCountsCLI.out > ${listOfFiles}


# gcpFileList="gs://anvil-gtex-v8-hg38-edu-ucsc-kim-lab-spark/quant/test6Samples/listOfFilesSelect.txt"
# # this will overwrite existing file
# gsutil cp ${listOfFiles}  ${gcpFileList}

quantFilesCSV="gs://anvil-gtex-v8-hg38-edu-ucsc-kim-lab-spark/quant/parseSalmonReadsSplitCLI/quantFilesCSV/sparkGTEx-trainQuantFiles.csv.batch-0"
