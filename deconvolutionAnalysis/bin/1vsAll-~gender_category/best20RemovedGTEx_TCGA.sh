...
# 11/15/23
# 
# runs analysis.BestRemoveHighDegreeSignatureGeneConfig
# 1) finds ${topN} genes for each class
# 2) drop all genes in intersections with degree > 10 
#
# uses intersection dictionary from upstream pipeline stage
# best${topN}GTEx_TCGA/ ... / best${topN}.intersection.dict
#
...
# example
# /private/groups/kimlab/aedavids/deconvolution/1vsAll-~gender_category/best20GTEx_TCGA/
#   training/best20GTEx_TCGA.sh.out/upsetPlot.out/best20.intersection.dict
