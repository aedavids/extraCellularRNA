...
# 11/15/23
#
# runs analysis.EnrichSignatureGeneConfig
# try to insure each type has a degree1 intersection with a minium of 3 of genes
#
# uses intersection dictionary from upstream pipeline stage
# best${topN}RemovedGTEx_TCGA/ ... best${topN}_degreeThreshold_10.intersection.dict
#
...
topN=100
degreeThreshold=10
numberOfGenesToAdd=3

title=` printf "best%s_degreeThreshold_%s_enrich_%s" $topN $degreeThreshold $numberOfGenesToAdd` # do not uses spaces, title will be part of file paths
...
# intersection dict from remove degree 10
designDir="1vsAll-~gender_category"
upsetOutBase="/private/groups/kimlab/aedavids/deconvolution/${designDir}/best${topN}RemovedGTEx_TCGA/training"
upsetOut="${upsetOutBase}/best${topN}RemovedGTEx_TCGA.sh.out/upsetPlot.out"
intersectionDict="${upsetOut}/best${topN}_degreeThreshold_${degreeThreshold}.intersection.dict"

# designDir="1vsAll-~gender_category"
# upsetOut="/private/groups/kimlab/aedavids/deconvolution/${designDir}/best${topN}GTEx_TCGA/training/best${topN}GTEx_TCGA.sh.out/upsetPlot.out"
# intersectionDict="${upsetOut}/best${topN}.intersection.dict"
