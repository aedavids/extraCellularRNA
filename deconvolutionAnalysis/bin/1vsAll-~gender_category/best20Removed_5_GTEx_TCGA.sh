...
topN=20
degreeThreshold=5
title=` printf "best%s_degreeThreshold_%s" $topN $degreeThreshold` # do not uses spaces, title will be part of file paths
designDir="1vsAll-~gender_category"

# upstream="/private/groups/kimlab/aedavids/deconvolution/1vsAll-~gender_category/best${topN}EnrichedGTEx_TCGA"
# upsetOut="${upstream}/training/best${topN}EnrichedGTEx_TCGA.sh.out/upsetPlot.out"

# upsetOut="/private/groups/kimlab/aedavids/deconvolution/1vsAll-~gender_category/${designDir}/best${topN}GTEx_TCGA/trainingSet/best${topN}GTEx_TCGA.sh.out/upsetPlot.out"
#-upsetOut="/private/groups/kimlab/aedavids/deconvolution/${designDir}/best${topN}GTEx_TCGA/trainingSet/best${topN}GTEx_TCGA.sh.out/upsetPlot.out"


upstream="/private/groups/kimlab/aedavids/deconvolution/${designDir}/best${topN}GTEx_TCGA"
upsetOut="${upstream}/training/best${topN}GTEx_TCGA.sh.out/upsetPlot.out"
