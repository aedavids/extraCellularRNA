...
# best${topN}EnrichedGTEx_TCGA/ ... / best${topN}_degreeThreshold_10_enrich_3.intersection.dict
#
...
#   best20EnrichedGTEx_TCGA/training/best20EnrichedGTEx_TCGA.sh.out/
#   upsetPlot.out/best20_degreeThreshold_10_enrich_3.intersection.dict
