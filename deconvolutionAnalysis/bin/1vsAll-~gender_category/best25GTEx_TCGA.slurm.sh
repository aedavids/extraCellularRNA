...
#
# copy everything to phoenix head node
# cp ~/extraCellularRNA/deconvolutionAnalysis/bin/{best25GTEx_TCGA.slurm.sh,pipeline.slurm.sh} .; ./best25GTEx_TCGA.slurm.sh aedwipSecurityToken ${USER}@ucsc.edu
#
