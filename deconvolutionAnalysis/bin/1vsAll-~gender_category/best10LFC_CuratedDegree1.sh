...
degree=1
windowLength=500
upstreamRun="best${upstreamTopN}LFC_FindAllDegree${degree}_wl${windowLength}"
...
intersectionDict="${upsetOut}/best${upstreamTopN}LFC_findAllDegree${degree}_wl${upstreamTopN}.intersection.dict"
