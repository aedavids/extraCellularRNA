...
# with degree 1.
#
# selects degree 1 intersection dictionary from upstream pipeline stage
# best${topN}GTEx_TCGA/ ... / upsetPlot.out/best${topN}.intersection.dict"
#
...
aedwip wrong upstream stage do not use bestN
exit 1

# example:
# /private/groups/kimlab/aedavids/deconvolution/1vsAll-~gender_category/
#     best200GTEx_TCGA/training/best200GTEx_TCGA.sh.out/upsetPlot.out/
#     best200.intersection.dict
upstream="/private/groups/kimlab/aedavids/deconvolution/1vsAll-~gender_category/best${topN}GTEx_TCGA"
#upsetOut="${upstream}/best${topN}GTEx_TCGA.sh/upsetPlot.out"
