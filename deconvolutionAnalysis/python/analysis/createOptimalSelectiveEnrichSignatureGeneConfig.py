...
from analysis.optimalSelectiveEnrichSignatureGeneConfig import __author__, __date__, __version__, __updated__
...
def createSignatureGeneConfig(outDirPath : str, vargs : list = None ) -> SignatureGeneConfiguration:
    ...
    cli = OptimalSelectiveEnrichSignatureGeneConfigCLI(version=__version__ , 
                            author=__author__ ,
                            date=__date__, 
                            update=__updated__)
    ...
    ret  = OptimalSelectiveEnrichSignatureGeneConfig(
