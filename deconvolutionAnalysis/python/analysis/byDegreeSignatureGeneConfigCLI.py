#
# byDegreeSignatureGeneConfigCLI.py.py
# Andrew E. Davidson
# aedavids@uscs.edu
# 
...
###############################################################################
class ByDegreeSignatureGeneConfigCLI( BestSignatureGeneConfigCommandLine ):
    '''
    ...
    def _build( self ):
        ...
        self.requiredArg.add_argument( '-dg', '--degree', required=True, default="1", metavar="",   
                                            action='store', 
                                            type=int,
                                            help="integer. select genes in intersections with degree"
        )       